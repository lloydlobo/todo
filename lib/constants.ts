import { PokemonSpecies, StoreActionsType } from "./interfaces";

export const URL_API = "http://localhost:3000/api/task";
export const COOKIE_STORE_TASKS = "storeTasks";
export const COOKIE_COUNTER = "storeCounterValue";

export const STORE_ACTIONS: StoreActionsType = {
    STORE_ADD_TASKS: "STORE_ADD_TASKS",
    STORE_REMOVE_TASKS: "STORE_REMOVE_TASKS",
    STORE_RESET_TASKS: "STORE_RESET_TASKS",
    STORE_TOGGLE_COMPLETED: "STORE_TOGGLE_COMPLETED",
};

export const TASK_API_QUERY_KEY = { FETCH_TASK: "fetchTask" }

export const POKI_API_QUERY_KEY = {
    GET_POKEMON: "getPokemon",
    SEARCH_POKEMONS: "searchPokemons",
};
// Data from this endpoint - https://pokeapi.co/api/v3/pokemon-species/
export const ALL_POKEMON_SPECIES: PokemonSpecies[] = [
    {
        name: "bulbasaur",
