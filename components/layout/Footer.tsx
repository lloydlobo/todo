...
export function FooterShell() {
  return (
    <div className="footer container my-6 mx-auto bg-gray7/[0.02] p-8 text-center text-gray3 backdrop-blur-lg">
      <div className="mx-auto my-12 h-1 w-24 rounded-full bg-gray1 bg-gradient-to-r from-gray5 to-gray4 " />
      <div title="footer-items" className="grid w-full place-content-center">
        <div className="pt-10">
          ...
          <div className="mx-auto my-2 flex items-center justify-center">
            <a href="#" className="link">
              <i className="mx-2 inline-block w-6">
                {/* prettier-ignore */}
                <svg
          ...
          <div className="mx-auto py-3">
            ...
            <div className="inline-flex gap-[1ch] py-3">
              <Link href="/about">About</Link>|<Link href="Tasks">Tasks</Link>
            </div>
          </div>
          <Copyright />
        </div>
